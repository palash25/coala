...
def get_file_dict(filename_list, log_printer=None, allow_raw_files=False):
    ...
    for filename in filename_list:
        try:
            ...
            # UnicodeDecodeError in case of raw files so
            # that it moves into the except clause.
            ...
            if allow_raw_files:
                ...
                # In case raw files are not allowed they
                # need to be evicted out of the dict.
